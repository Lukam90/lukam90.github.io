...
chapelets = ["chapelet", "c-anges", "c-eucharistie", "c-liberation", "c-louanges", "c-merci", "c-misericorde", "c-sang"]

ch_saints = ["c-st-antoine", "c-ste-rita", "c-ste-therese"]
...
convert_jinja_single("chapelets/c-louanges")
